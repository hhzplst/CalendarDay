...
public class CalendarDay implements Comparable<CalendarDay> {
  ...
  public CalendarDay(String data) throws CalendarDayException {
  ...
  public CalendarDay(int m, int d, int y) throws CalendarDayException {
    checkValidity(m, d, y);
    month = m;
    day = d;
    year = y;
  ...
  public void setMonth(int m) throws CalendarDayException {
    checkValidity(m, day, year);
    month = m;
  }

  public void setDay(int d) throws CalendarDayException {
    checkValidity(month, d, year);
    day = d;
  }

  public void setYear(int y) throws CalendarDayException {
  ...
  private static void checkValidity(int m, int d, int y) throws CalendarDayException {
